...
function main() {
  ...
  loader.load('https://cdn.jsdelivr.net/npm/three@0.158.0/examples/fonts/helvetiker_regular.typeface.json', function (font) {
    const textGeometry = new TextGeometry('wassup bitch', {
      font: font,
      size: 5,
      height: 1,
      curveSegments: 12,
    ...
    addSolidGeometry(-3, 1, textGeometry);
  });

  {
    ...
    async function doit() {
      const font = await loadFont('../node_modules/three/examples/fonts/helvetiker_regular.typeface.json');  /* Adjust the path if necessary */
